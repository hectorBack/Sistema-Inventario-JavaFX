...
public final class ProductoDTO {
    ...
    public ProductoDTO(Integer id, String codigoBarras, String nombre, String descripcion, BigDecimal precio,
            BigDecimal precioMayoreo, BigDecimal precioCompra, BigDecimal porcentajeGanancia, BigDecimal stock,
            BigDecimal stockMinimo, String tipoVenta, String estado, Integer categoriaId, Integer proveedorId) {
        this.id = id;
